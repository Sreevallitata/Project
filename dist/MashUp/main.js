...
let MacrosComponent = class MacrosComponent {
    constructor(_http, titleService) {
        this._http = _http;
    ...
    getMacroInfo() {
        ...
        if (this.userValue !== null || this.userValue !== '') {
            this._http.get('https://api.nal.usda.gov/fdc/v1/foods/search?api_key=' + this.USDAKey + '&query='
                + this.userValue)
                .subscribe((data) => {
                this.macroList = Object.keys(data.foods).map(function () {
...
// @ts-ignore
// @ts-ignore
let ProteinComponent = class ProteinComponent {
    constructor(_http, titleService) {
        this._http = _http;
        this.titleService = titleService;
    ...
    getProteinInfo() {
        ...
        if (this.choiceList !== null) {
            this._http.get('https://api.edamam.com/search?q=' + this.choiceList[0] + '%20' + this.choiceList[1] + '%20' +
                ...
                .subscribe((data) => {
                console.log(data);
                this.foodList = Object.keys(data.hits).map(function (k) {
...
// @ts-ignore
let cheatsheetComponent = class cheatsheetComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
module.exports = "<form action=\"/protein.component.html\" [formGroup]=\"registerForm\" (ngSubmit)=\"onFormSubmit(registerForm.value)\" method=\"post\">\n\n  <div class=\"form-group\">\n    <label for=\"email\">Email address:</label>\n    <input type=\"email\" class=\"form-control\" id=\"email\" formControlName=\"email\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"pwd\">Password:</label>\n    <input type=\"password\" class=\"form-control\" id=\"pwd\" formControlName=\"password\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"rpwd\">Re-enter Password:</label>\n    <input type=\"rpassword\" class=\"form-control\" id=\"rpwd\" formControlName=\"re_enter_password\">\n  </div>\n  <button type=\"submit\" class=\"btn btn-primary\">Submit</button>\n</form>\n"
...
module.exports = "<form action=\"/protein.component.html\" [formGroup]=\"registerForm\" (ngSubmit)=\"onFormSubmit(registerForm.value)\" method=\"post\">\n\n  <div class=\"form-group\">\n    <label for=\"fn\">First name</label>\n    <input type=\"fn\" class=\"form-control\" id=\"fn\" formControlName=\"fn\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"ln\">Last name</label>\n    <input type=\"ln\" class=\"form-control\" id=\"ln\" formControlName=\"ln\">\n  </div>\n    <div class=\"form-group\">\n      <label for=\"email\">Email address:</label>\n      <input type=\"email\" class=\"form-control\" id=\"email\">\n    </div>\n    <div class=\"form-group\">\n      <label for=\"pwd\">Password:</label>\n      <input type=\"password\" class=\"form-control\" id=\"pwd\">\n    </div>\n  <div class=\"form-group\">\n    <label for=\"re_enter_password\">re-enter Password:</label>\n    <input type=\"rpassword\" class=\"form-control\" id=\"re_enter_password\">\n  </div>\n    <div class=\"checkbox\">\n      <label><input type=\"checkbox\"> Remember me</label>\n    </div>\n    <button type=\"submit\" class=\"btn btn-primary\">Submit</button>\n  </form>\n"
...
let RegistrationComponent = class RegistrationComponent {
    constructor(api_srvc, formBuilder, router) {
...
module.exports = __webpack_require__(/*! C:\Users\Student\Protein\src\main.ts */"./src/main.ts");
